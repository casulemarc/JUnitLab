...
class GradebookTester {
	...
	/*
	 * Test for the sum of the scores
	 */
	@Test
	void testSum() {
	...
	/*
	 * Test for the minimum score, or 0 if there are no scores.
	 */
	...
	/*
	 * Test if the sum of the scores, with the lowest score dropped if there are at
